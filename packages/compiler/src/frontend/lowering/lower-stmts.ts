...
import { ambientUndefVarRootOf, lowerImportEquals, moduleNsConstAliasDecl, nsUndefRead, nsWritableTarget, trapDeclRootOf } from "./lower-namespaces.js";
